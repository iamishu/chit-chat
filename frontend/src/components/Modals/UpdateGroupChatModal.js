...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain }) => {
    ...
    const handleLeave = async () => {
        try {
            ...
            user._id === selectedChat.groupAdmin._id ? setSelectedChat() : setSelectedChat(data);
            setFetchAgain(!fetchAgain);
        } catch (error) {
            toast({
                title: "Error Occured!",
        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={closeModal} isCentered scrollBehavior='inside' size="full">
                ...
                <ModalContent pb="20px" bg="#f0f2f5">
                            ...
                            >
                                <InputGroup>
                                    <Input
                                        ...
                                        mb={3}
                                        value={!groupChatName ? selectedChat.chatName : groupChatName}
                        ...
                        >
                            ...
                            >
                                {user._id === selectedChat.groupAdmin._id && (
                                    <AddMemberModal fetchAgain={fetchAgain} setFetchAgain={setFetchAgain}>
                                        <Box
                                            w="100%"
                                            variant="ghost"
                                            textAlign="left"
                    ...
                    <ModalFooter>
                        <Button isLoading={leaveLoading} colorScheme='red' onClick={handleLeave}>
                            Leave Group
                        </Button>
                    </ModalFooter>
                </ModalContent>
